...
<div class="judul text-center mt-5">
          <h3 class="card-title">PT Yanno Agro Science</h3>
          <p></p>
...
<div class="card">
  <div class="card-body">
    <h5 class="card-title">Kantor Pusat : Tangerang Selatan</h5>
  </div>
</div>
<p></p>
...
<div class="card">
  <div class="card-body">
    <h5 class="card-title">Tentang PT Yanno Agro Science :</h5>
                <h6 class="m-0">PT Yanno Agro Science adalah perusahaan nasional yang mengkhususkan diri dalam pengembangan, pembuatan, dan pemasaran bahan kimia pelindung perusahaan di Indonesia.  </h6>
  </div>
</div>
<p></p>
