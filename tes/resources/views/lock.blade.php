...
<div class="judul text-center mt-5">
          <h3 class="card-title">PT Lock & Lock</h3>
          <p></p>
          <a href= "/perusahaan" type="button" class="btn btn-outline-danger">Back</a>
</div>
<p></p>
...
<div class="card">
  <div class="card-body">
    <h5 class="card-title">Kantor Pusat : Jakarta Selatan</h5>
  </div>
</div>
<p></p>
...
<div class="card">
  <div class="card-body">
    <h5 class="card-title">Tentang PT Lock & Lock :</h5>
                <h6 class="m-0">PT Lock & Lock adalah perusahaan global yang mengekspor produknya ke 113 negara di seluruh dunia. </h6>
                <h6 class="m-0">perusahaan telah memantapkan dirinya sebagai salah satu merek terkemuka di dapur dan peralatan rumah tangga yang komprehensif, memberikan produk unik dan inovatif yang membuat kehidupan sehari-hari lebih baik bagi konsumen. </h6>
  </div>
</div>
<p></p>
...
<div class="card">
  <div class="card-body">
    <h5 class="card-title">Lowongan Kerja di PT Ananta Swasta Dana</h5>
              <div class="container">
                <div class="row mt-3">
                <div class="col-md-3">
