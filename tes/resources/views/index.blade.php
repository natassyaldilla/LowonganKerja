    ...
    <nav class="navbar navbar-expand-lg bg-light fixed-top">
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <li class="nav-item">
                <a class="nav-link" aria-current="page" href="/index"><span class="text-body">Home</span></a>
              </li>
              <li class="nav-item">
                <a class="nav-link" aria-current="page" href="/login"><span class="text-danger">LOG IN</span></a>
              </li>
              <li class="nav-item">
                <a class="nav-link" aria-current="page" href="/register"><span class="text-warning">DAFTAR</span></a>
              </li>
              </ul>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="section-header text-center pb-5">
            <p> </p>
            <h2> Project By </h2>
            <p class="card-text"> Pemrograman Web Berbasis Framework</p>
          </div>
        </div>
      </div>
      <div class="row">
