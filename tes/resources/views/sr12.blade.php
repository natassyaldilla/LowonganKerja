...
<html lang="en">
  <head>
    ...
    <title>PT SR12 Herbal Kosmetik</title>
  </head>
  <body>
...
<div class="judul text-center mt-5">
          <h3 class="card-title">PT SR12 Herbal Kosmetik</h3>
          <p></p>
...
<div class="card">
  <div class="card-body">
    <h5 class="card-title">Kantor Pusat : Bogor</h5>
  </div>
</div>
<p></p>
...
<div class="card">
  <div class="card-body">
    <h5 class="card-title">Tentang PT SR12 Herbal Kosmetik :</h5>
                <h6 class="m-0">PT SR12 Herbal Kosmetik adalah General Distributor Utama Resmi produk - produk kecantikan dari PT.  </h6>
                <h6 class="m-0">SR12 Herbal sebagai produsen. SR12 Herbal Skin Care merupakan produk kecantikan berbahan dasar herbal. </h6>
  </div>
</div>
<p></p>
