...
<html lang="en">
  <head>
    ...
    <title>PT Sekarguna Medika</title>
  </head>
  <body>
...
<div class="judul text-center mt-5">
          <h3 class="card-title">PT Sekarguna Medika</h3>
          <p></p>
...
<div class="card">
  <div class="card-body">
    <h5 class="card-title">Tentang PT Sekarguna Medika :</h5>
                <h6 class="m-0">PT Sekarguna Medika adalah Perusahaan yang bergerak dibidang distribusi alat kesehatan. </h6>
                <h6 class="m-0">Perusahaan ini didirikan pada tahun 1991, sebagai distributor eksklusif dari 28 merek internasional terkemuka peralatan medis </h6>
  </div>
</div>
<p></p>
